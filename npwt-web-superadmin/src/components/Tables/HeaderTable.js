...
export default function HeaderTable({limit,changeLimit,handleSearchSubmit,handleSearchTermChange,max,tableName  }) {
  return (
...
/>
        ...
        <Link to={`/${tableName}/ajouter`} style={{ textDecoration: "none", color: "inherit" }}>
